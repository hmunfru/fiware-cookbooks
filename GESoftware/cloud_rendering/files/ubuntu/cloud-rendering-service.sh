...
#
# ------------------------------------------------------------------------------ 
# Based on https://gist.github.com/peterhost/715255 - https://github.com/peterhost
# ------------------------------------------------------------------------------ 
...
DAEMON_ARGS="/usr/local/src/cloud-rendering/service/signalingserver/server.js"
											# path to your node.js server/app
                                            # NB: don't use ~/ in path
 
DESC="node.js cloud rendering service"      # whatever fancy description you like
...
LOCAL_VAR_RUN=/usr/local/src/cloud-rendering 
...
[ $UID -eq "0" ] && LOCAL_VAR_RUN=/usr/local/src/cloud-rendering
THIS_ARG=$0
