...
if platform?("ubuntu") and node[:platform_version] == "12.04"
	log "Ubuntu 12.04 detected, stopping POI data provider..."
	...
	Chef::Application.fatal!("This chef recipe for stopping the POI data provider supports only Ubuntu 12.04!")
end
