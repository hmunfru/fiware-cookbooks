...
#
default[:mongodb][:node_name] = "mongodb"
...
default[:mongodb][:cluster_name] = "test"

default[:mongodb][:mongodb_cluster_name] = "test"
default[:mongodb][:replicaset_name] = "replicaname"
